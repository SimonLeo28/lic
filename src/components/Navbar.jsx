    ...
    <nav className="fixed top-0 left-0 w-full bg-white text-gray-800 p-4 shadow-md z-50">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          <Link to="/Plans" className="text-gray-600 hover:text-blue-600 font-medium transition-colors duration-300">
            Plans
          </Link>
          ...
          <Link
            to="/Contact"
            className="bg-blue-600 text-white px-4 py-2 text-sm font-semibold rounded-lg shadow-md hover:bg-blue-700 transition-all duration-300"
          >
            Contact Us
          </Link>
        </div>
        ...
        <div className="md:hidden mt-4 bg-white">
          <ul className="flex flex-col items-center gap-4 py-4">
            ...
            <li>
              <Link
                to="/Contact"
                className="bg-blue-600 text-white px-6 py-2 font-semibold rounded-lg shadow-md hover:bg-blue-700 transition-all duration-300"
                onClick={() => setIsOpen(false)}
              >
                Contact Us
              </Link>
